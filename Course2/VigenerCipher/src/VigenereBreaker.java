...
public class VigenereBreaker {
    ...
    public int[] tryKeyLength(String encrypted, int klength, char mostFreqChar) {
        int[] key = new int[klength];
        CaesarBreaker caesarCracker = new CaesarBreaker(mostFreqChar);
    ...
    public void breakVigenere() {
        FileResource fileResource = new FileResource("/home/fazil/Documents/Assignment/secretmessage1.txt");
